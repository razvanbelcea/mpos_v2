...
Public Class DbQueries
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Main.MetroLabel15.Text = "ONLINE" Then
                    ...
                    If item.checked = True Then
                        ...
                        If dat.HasRows Then
                            While dat.Read()
                                ...
                                row(4) = Main.MetroLabel10.Text
                                row(5) = Main.MetroLabel9.Text
            ...
            Catch af As Exception
                miniTool.balon(af.Message)
            End Try
        Else
            miniTool.balon("Server is offline ...")
        End If
        If ssels = 0 Then
            miniTool.balon("No selection has been made ...")
        End If
    End Sub
    ...
    Private Sub chnrefresh()
        ...
        Try
            ...
            Else
                For i = 0 To 19
                    cd = 0
                    bar1 = Main.MetroLabel10.Text.ToString().PadLeft(2, "0") + "140000" + i.ToString().PadLeft(2, "0")
                    bar2 = Main.MetroLabel10.Text.ToString().PadLeft(2, "0") + "240000" + i.ToString().PadLeft(2, "0")
                    For j = 1 To 10
    ...
    Private Sub printPDF(barcodetype)
        ...
        'Open PDF doc
        pdfdoc.Open()
        Dim p As Paragraph = New Paragraph("-=" + barcodetype.ToString + " - Country: " + Main.MetroLabel9.Text + " - Store: " + Main.MetroLabel10.Text + " =-")
