...
Public Class barcodeG
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        If TextBox13.Text.Length <= 6 Then
            ...
            Try
                ...
                dat1.Close()
                con1.Close()
                If DBQueries.setbarart(itemlook(0).ToString) Then
        ...
        Else
            'create barcode
            If DBQueries.setbarart(TextBox13.Text) Then
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If DBQueries.setbarcus(TextBox7.Text) Then
    ...
    Private Sub TextBox11_TextChanged(sender As Object, e As EventArgs) Handles TextBox8.TextChanged, TextBox9.TextChanged, TextBox10.TextChanged, TextBox12.TextChanged
        If TextBox8.Text.Length < 1 And TextBox9.Text.Length < 1 And TextBox10.Text.Length < 1 And TextBox12.Text.Length < 1 Then
            Button4.Enabled = False
        Else
